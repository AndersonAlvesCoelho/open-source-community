import { Cards as CardsIcon, Sidebar } from "phosphor-react";
import { useState } from "react";
import { Link, Outlet } from "react-router-dom";
import { Header, NavBar } from "../../components/Navbars";
...
export default function LayoutStyleGuide() {
  ...
  const optionSideBar = [
    ...
    },
    {
      ...
      name: RoutesPages.Typography.name,
      icon: RoutesPages.Typography.icon,
    },
    {
      path: RoutesPages.Blogs.path,
      name: RoutesPages.Blogs.name,
      icon: RoutesPages.Blogs.icon,
    },
  ];
        ...
        <div className="flex flex-col w-full px-4 py-8 overflow-y-auto border-b lg:border-r lg:h-screen lg:w-64 bg-white">
          ...
          <div className="p-8 rounded-lg">
            <ul className="text-indigo-800">
              <li className="px-4 py-2 hover:bg-indigo-50 rounded-lg">Pilot</li>
              <li className="px-4 py-2 bg-indigo-800 text-white rounded-lg">
                Titan
              </li>
              <li className="px-4 py-2 hover:bg-indigo-50 rounded-lg">
                Timelines
              </li>
            </ul>

            <p className="text-indigo-600 font-bold my-3">Training:</p>
